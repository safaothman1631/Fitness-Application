            ...
            <CardContent className="space-y-4">
              ...
              <div className="transition-all duration-300 focus-within:scale-105">
                ...
                <Input 
                  ...
                  type="email" 
                />
                <p className="text-xs text-gray-500 mt-1">Email cannot be changed</p>              </div>
              ...
              >
                ...
                {saving ? "Saving..." : t("saveChanges")}              </AnimatedButton>
            </CardContent>
          </Card>
        </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                <option value="flexibility">{t("flexibility")}</option>              </select>
            </div>
            ...
            >
              <Save className="w-4 h-4" />
              {saving ? "Saving..." : t("saveFitnessInfo")}            </AnimatedButton>
          </CardContent>
        </Card>
      </div>
    </FitproLayout>
